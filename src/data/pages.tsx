...
const pageData = {
	...
	contact: {
		title: 'Contact',
		about: 'I am available on almost every social media. You can message me, I will reply within 24 hours. I can help you with MERN Stack, React Native, Python and Open-source Development.',
		gradientFrom: 'from-[#00D3FF]',
		gradientTo: 'to-[#8C2CE3]',
	},
};
